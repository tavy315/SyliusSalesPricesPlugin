function hideOtherSalesPricesTable(targetTableId) {
    $('#sales_prices_tables').children().each(function () {
        var element = $(this);
...
$(document).ready(function () {
    ...
    hideOtherSalesPricesTable(tableId);
});
...
$('[name="sylius_add_to_cart[cartItem][variant]"]').on('change', function (event) {
    ...
    hideOtherSalesPricesTable(targetTableId);
});
